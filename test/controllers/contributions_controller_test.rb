...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { name: @contribution.name, officialContribution: @contribution.officialContribution }
    end
  ...
  test "should update contribution" do
    patch :update, id: @contribution, contribution: { name: @contribution.name, officialContribution: @contribution.officialContribution }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
